...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|      | Alt  |Symbol| Eisuu|  GUI |Enter |Space | Bksp | Kana |  Alt |      |      | Shift|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  SCRLOCK, KC_LALT, SYMBOL, KC_LANG2, KC_LGUI, KC_ENT,  KC_SPC,  KC_BSPC, KC_LANG1, KC_RALT, _______, _______, KC_RSFT  \
      ),
