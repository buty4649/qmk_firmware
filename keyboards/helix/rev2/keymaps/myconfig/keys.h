...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|ScrLck| Alt  |Symbol| Eisuu|  GUI |Enter |Space | Bksp | Kana |  Alt | COPY |PASTE | Shift|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  SCRLOCK, KC_LALT, SYMBOL, KC_LANG2, KC_LGUI, KC_ENT,  KC_SPC,  KC_BSPC, KC_LANG1, KC_RALT, COPY,   PASTE,   KC_RSFT  \
      ),
  ...
  [_SYMBOL] = KEYMAP( \
      ...
      _______, _______, _______, _______, _______, _______,                     _______, JA_CIRC, JA_TILD, JA_JYEN, JA_PIPE, _______, \
