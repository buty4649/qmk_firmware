...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|      |      | Alt  |Symbol|  GUI |Enter |Space |Raise | Bksp | Alt  |      |      | Shift|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  _______, _______, KC_LALT, SYMBOL, KC_LGUI, KC_ENT,  KC_SPC,  KC_BSPC, KC_RALT, _______, _______, _______, KC_RSFT  \
      ),
