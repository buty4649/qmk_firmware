const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |  @ ` |  [ { |   N  |   M  |  , < |  . > |  / ? |  : * |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|  ` ~ | Alt  | GUI  | EISU |Lower |Enter |Space |Raise | KANA | Left |  Up  | Down |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  KC_GRV,  KC_LALT, KC_LGUI, KC_LALT, LOWER,  KC_ENT,  KC_SPC,  RAISE,   KANA,    KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT \
      ),
   ...
   * |      |  F1  |  F2  |  F3  |  F4  |  F5  |             |  F6  |   =  |   ~  |   `  |   +  |  }   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  )   |   0  |  F12 |      |      | Home | End  | _    |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      | Next | Vol- | Vol+ | Play |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_LOWER] = KEYMAP( \
      ...
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_LPRN, KC_RPRN, KC_F12,  _______, _______, KC_HOME, KC_END,  KC_RO, \
