const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |  @ ` |  [ { |   N  |   M  |  , < |  . > |  / ? |  : * |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|  ` ~ | Alt  | GUI  | EISU |Lower |Space |Space |Raise | KANA | Left |  Up  | Down |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  KC_GRV,  KC_LALT, KC_LGUI, EISU,    LOWER,   KC_SPC,  KC_SPC,  RAISE,   KANA,    KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT \
      ),
